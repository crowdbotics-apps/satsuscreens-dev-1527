variable "app_name" {
  ...
  type = "string"
  default = "satsuscreens-dev-1527"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "satsuscreens-dev-1527.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/satsuscreens-dev-1527/archive/master.tar.gz"
}
